...
path = "C:\\Users\\Luka\\Dropbox\\My PC (DESKTOP-E57AO1D)\\Desktop\\Dusan pollen\\projekat\\pollen\\test"
...
data = import_data("C:\\Users\\Luka\\Dropbox\\My PC (DESKTOP-E57AO1D)\\Desktop\\Dusan pollen\\projekat\\pollen\\test\\New Folder\\")
...
path = "C:\\Users\\Luka\\Dropbox\\My PC (DESKTOP-E57AO1D)\\Desktop\\Dusan pollen\\projekat\\pollen\\test\\New Folder\\"
test_scat, test_spec, test_life= data_and_labels(path, data)
...
def export_data_and_labels(p):
    ...
    file_name = "test_scat.pkl"
    open_file = open(file_name, "wb")
    pickle.dump(test_scat, open_file)
    open_file.close()

    file_name = "test_spec.pkl"
    open_file = open(file_name, "wb")
    pickle.dump(test_spec, open_file)
    open_file.close()

    file_name = "test_life.pkl"
    open_file = open(file_name, "wb")
    pickle.dump(test_life, open_file)
    open_file.close()
